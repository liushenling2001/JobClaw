...
- JDK 17+
- Maven 3.6+
- 网络可访问 Maven 仓库和 npm registry，首次完整打包需要下载后端依赖和前端依赖。
- Node.js 不是后端运行必需项；Maven 打包会通过 frontend-maven-plugin 下载指定版本的 Node/npm。
- 本地前端开发需要 Node.js 18+。
