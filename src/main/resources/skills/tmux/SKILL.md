...
Use tmux only when you need an interactive TTY. Prefer run_command background mode for long-running, non-interactive tasks.

## Quickstart (isolated socket, run_command tool)
